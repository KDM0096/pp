...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = ArrayAdapter.createFromResource(this, R.array.crMajor, android.R.layout.simple_spinner_dropdown_item);
                    ...
                    public void onResponse(String response) {
                        try
                        {
                            ...
                            if(success){
                                ...
                                validate = true;
                                idText.setBackground(getResources().getDrawable(R.drawable.validateshape));
                                validateButton.setBackgroundColor(getResources().getColor(R.color.colorBlue));
                            }
                            else {
                                AlertDialog.Builder builder = new AlertDialog.Builder(RegisterActivity.this);
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    AlertDialog.Builder builder = new AlertDialog.Builder(RegisterActivity.this);
                    dialog = builder.setMessage("중복체크는 필수입니다")
                            .setNegativeButton("확인",null)
                            .create();
                    dialog.show();
                    return;
