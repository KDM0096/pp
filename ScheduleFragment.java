...
public class ScheduleFragment extends Fragment {
    ...
    private AutoResizeTextView monday[] = new AutoResizeTextView[9];
    private AutoResizeTextView tuesday[] = new AutoResizeTextView[9];
    private AutoResizeTextView wednesday[] = new AutoResizeTextView[9];
    private AutoResizeTextView thursday[] = new AutoResizeTextView[9];
    private AutoResizeTextView friday[] = new AutoResizeTextView[9];
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String>
    {
        ...
        protected void onPreExecute() {
            try {
                target = "http://222.117.131.189:80/ScheduleList.php?userID=" + URLEncoder.encode(MainActivity.userID, "UTF-8");
            }
            catch (Exception e) {
                e.printStackTrace();
            }
        ...
        public void onPostExecute(String result) {
            try {
                ...
                while(count < jsonArray.length()) {
                    ...
                    schedule.addSchedule(crTime, crTitle, crProfessor);
                    count++;
                }
            }
            catch (Exception e)
